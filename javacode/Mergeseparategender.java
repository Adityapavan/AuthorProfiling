...
public class Mergeseparategender {
	public static void main(String[] args) throws IOException {
		// TODO Auto-generated method stub
		String afile=args[0];//"/home/dharmesh/aditya/mallet-2.0.7/entestingforsvmfemale.out";
		String afile2=args[1];//"/home/dharmesh/aditya/mallet-2.0.7/entestingforsvmmale.out";
		
		String bfile=args[2];//"/home/dharmesh/aditya/mallet-2.0.7/entestfullgender.csv";
		...
		while((line=br1.readLine())!=null)
		{
			...
			put = put + s[1].split("_")[8].charAt(0);
			Double[] num=new Double[501];
